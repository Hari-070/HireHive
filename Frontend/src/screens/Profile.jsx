  ...
  const profileRet = async () => {
    try {
      const res = await axios.post(
        "http://" + Metro_Bundler_Url + ":3000/getProfile",
        { username }
      );
    ...
    <ScrollView>
      ...
      >
        <View>
          <TouchableOpacity onPress={selectImageBanner}>
            {ban ? (
              ...
              <Image
                source={{
                  uri: "https://t3.ftcdn.net/jpg/06/04/96/54/360_F_604965492_lCfxDUwNF1YiogR3SN0lbmbdvFnfDCHa.jpg",
                }}
                style={{
                  width: 380,
                  height: 200,
        ...
        <View style={{ margin: 20 }}>
          ...
          <Text style={{ fontSize: 13.5, textAlign: "left", marginLeft: 20 }}>
            {data?.desc ||
              "Lorem ipsum dolor sit, amet consectetur adipisicing elit. Tenetur nam delectus eveniet velit porro, cum repellendus ex expedita nostrum quis! Consequatur quaerat alias doloremque nesciunt. Tempora adipisci at sunt quas."}
          </Text>
        </View>
        <View style={{ margin: 20 }}>
          <Text style={{ fontSize: 20, fontWeight: "500", marginTop: 20 }}>
        ...
        <View style={{ marginTop: 50, marginBottom: 10 }}>
          <Text style={{ fontSize: 13, textAlign: "center", marginBottom: 8 }}>
            Connect With Us
          </Text>
          <Divider inset={true} insetType="middle" width={0.8} />
          <View
          ...
          <Text style={{ fontSize: 10, textAlign: "center", marginTop: 10 }}>
            © HireHive 2024 All rights reserved
          </Text>
        </View>
      </View>
    </ScrollView>
